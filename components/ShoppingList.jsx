...
export default function ShoppingList({ ingredients }) {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm space-y-6 dark:bg-gray-700">
      ...
      {/* Conditionally render the Shopping List */}
      {isVisible && (
        <>
          ...
          {selectedItems.length > 0 && (
            <div className="mt-6 space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-teal-600 text-white py-2 px-4 rounded-lg hover:bg-teal-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed dark:bg-teal-500 dark:hover:bg-teal-600"
              >
                {loading ? (
              ...
              {lists.length > 0 && (
                <div className="relative">
                  <button
                    onClick={() =>
                      setSelectedListId(selectedListId ? null : "select")
                    }
