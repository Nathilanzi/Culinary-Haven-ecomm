/**
 * @fileoverview Contains SVG icons used in the application, including serving, cook, time, nutrition icons, and allergen-related icons.
 */

/**
 * SVG icon for time representation.
 * @constant
...
/**
 * SVG icon for total preparation and cooking time.
 * @constant
 * @type {React.FC<React.SVGProps<SVGSVGElement>>}
 */
...
/**
 * SVG icon for serving size representation.
 * @constant
 * @type {React.FC<React.SVGProps<SVGSVGElement>>}
 */
...
/**
 * SVG icon for cooking-related representation.
 * @constant
 * @type {React.FC<React.SVGProps<SVGSVGElement>>}
 */
...
/**
 * SVG icon for nutritional information representation.
 * @constant
 * @type {React.FC<React.SVGProps<SVGSVGElement>>}
 */
...
/**
 * SVG icon for search representation.
 * @constant
 * @type {React.FC<React.SVGProps<SVGSVGElement>>}
 */
...
/**
 * Object containing SVG icons for common allergens.
 * Keys represent allergen names, and values are corresponding SVG icons.
 * @constant
 * @type {Object<string, React.FC<React.SVGProps<SVGSVGElement>>>}
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} nut - SVG icon for nuts.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} soy - SVG icon for soy.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} wheat - SVG icon for wheat.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} milk - SVG icon for milk.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} cheese - SVG icon for cheese.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} cream - SVG icon for cream.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} egg - SVG icon for eggs.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} fish - SVG icon for fish.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} sesame - SVG icon for sesame seeds.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} mustard - SVG icon for mustard.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} corn - SVG icon for corn.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} clam - SVG icon for clams.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} mussel - SVG icon for mussels.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} oyster - SVG icon for oysters.
 * @property {React.FC<React.SVGProps<SVGSVGElement>>} celery - SVG icon for celery.
 */
// Allergen SVG mapping
export const allergenSVGs = {
  nut: (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M7.5 4.20573C5.56566 5.32252 4.85134 7.61813 6.0359 9.66983C6.38397 10.2727 6.86005 10.6249 7.54765 11.1297C8.21809 11.6219 9.05126 12.2376 9.68554 13.3362C10.3198 14.4348 10.4365 15.4642 10.5275 16.2909C10.6208 17.1388 10.6878 17.7272 11.0359 18.3301C12.2205 20.3818 14.5657 20.911 16.5 19.7942C18.4343 18.6774 19.1487 16.3818 17.9641 14.3301C17.616 13.7272 17.1399 13.375 16.4523 12.8702C15.7819 12.3781 14.9487 11.7623 14.3145 10.6637C13.6802 9.56509 13.5635 8.53568 13.4725 7.70898C13.3792 6.86113 13.3122 6.27271 12.9641 5.66983C11.7795 3.61813 9.43434 3.08894 7.5 4.20573ZM4.30385 10.6698C2.54288 7.61975 3.65141 4.11832 6.5 2.47368C9.34859 0.829048 12.9352 1.61975 14.6962 4.66983C15.2598 5.64608 15.3646 6.60961 15.449 7.3849L15.4605 7.49014C15.5501 8.30368 15.6398 8.95931 16.0465 9.66371C16.4532 10.3681 16.9761 10.7737 17.6359 11.258L17.7213 11.3206C18.3505 11.7813 19.1325 12.3538 19.6962 13.3301C21.4571 16.3802 20.3486 19.8816 17.5 21.5262C14.6514 23.1709 11.0648 22.3802 9.30385 19.3301C8.74021 18.3538 8.63536 17.3903 8.551 16.615L8.5395 16.5098C8.44995 15.6962 8.36018 15.0406 7.95349 14.3362C7.54681 13.6318 7.0239 13.2263 6.36413 12.7419L6.27874 12.6794C5.6495 12.2186 4.86748 11.6461 4.30385 10.6698ZM9 8.99988C9 9.55216 8.55228 9.99988 8 9.99988C7.44772 9.99988 7 9.55216 7 8.99988C7 8.44759 7.44772 7.99988 8 7.99988C8.55228 7.99988 9 8.44759 9 8.99988ZM8 6.99988C8.55228 6.99988 9 6.55216 9 5.99988C9 5.44759 8.55228 4.99988 8 4.99988C7.44772 4.99988 7 5.44759 7 5.99988C7 6.55216 7.44772 6.99988 8 6.99988ZM12 9.99988C12 10.5522 11.5523 10.9999 11 10.9999C10.4477 10.9999 10 10.5522 10 9.99988C10 9.44759 10.4477 8.99988 11 8.99988C11.5523 8.99988 12 9.44759 12 9.99988ZM14 18.9999C14.5523 18.9999 15 18.5522 15 17.9999C15 17.4476 14.5523 16.9999 14 16.9999C13.4477 16.9999 13 17.4476 13 17.9999C13 18.5522 13.4477 18.9999 14 18.9999Z"
          fill="#000000"
        ></path>
      </g>
    </svg>
  ...
  wheat: (
    ...
    >
      ...
      ></g>
      <g id="SVGRepo_iconCarrier">
        <path d="M50.364,254c-30.937-2.154-54.825-30.154-46.21-63.832C30.196,199.958,51.538,214.839,50.364,254 M56.238,78.951 C28.825,64.657,18.056,29.413,39.007,2C58.979,21.385,72.881,43.315,56.238,78.951 M65.636,177.832 c30.937-2.35,54.825-30.154,46.21-63.832C85.804,123.79,64.462,138.671,65.636,177.832 M65.636,238.336 c30.937-2.35,54.825-30.154,46.21-63.832C85.804,184.294,64.462,199.175,65.636,238.336 M65.636,117.329 c30.937-2.154,54.825-30.154,46.21-63.832C85.804,63.287,64.462,78.168,65.636,117.329 M50.364,193.692 c-30.937-2.35-54.825-30.35-46.21-63.832C30.196,139.65,51.538,154.531,50.364,193.692 M50.364,133.189 c-30.937-2.35-54.825-30.154-46.21-63.832C30.196,79.147,51.538,94.028,50.364,133.189"></path>
      </g>
    </svg>
  ),
  milk: (
    ...
    >
      ...
      <g fillRule="evenodd" clipRule="evenodd" strokeLinecap="round">
        <path d="M12.55,0h30.04c1.28,0,2.45,0.52,3.3,1.37c0.84,0.84,1.37,2.01,1.37,3.3v6.99c0,1.28-0.52,2.45-1.37,3.29c-0.84,0.84-2.01,1.37-3.3,1.37h-0.57c3.81,6.51,6.8,13.22,8.95,20.12c2.39,7.63,3.77,15.5,4.16,23.62c0,0.03,0,0.05,0,0.08h0v48.95c0,0.07,0,0.14-0.01,0.21c-0.17,3.66-1.07,6.72-2.87,9.05c-1.87,2.42-4.63,3.98-8.44,4.52c-0.08,0.01-0.16,0.02-0.25,0.02v0H11.91c-0.07,0-0.14,0-0.21-0.01c-3.5-0.15-6.14-1.34-8.08-3.39c-1.9-2.02-3.04-4.81-3.59-8.23c-0.01-0.09-0.02-0.18-0.02-0.27H0v-50.7c0-0.08,0-0.15,0.01-0.22C0.7,51.32,2.21,43.21,4.4,35.77c2.1-7.12,4

    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <g>
          <path d="M265.5,116.033V92.326c0-6.797-5.529-12.326-12.326-12.326h-22.913l-5.242-68.862C224.543,4.892,219.264,0,213,0 c-6.264,0-11.542,4.892-12.018,11.138L195.74,80h-22.914c-6.797,0-12.326,5.529-12.326,12.326v23.707 c-11.685,0.624-21,10.326-21,22.164V386.5c0,11.785,8.085,21.716,19,24.539v10.46c0,2.485,2.015,4.5,4.5,4.5h100 c2.485,0,4.5-2.015,4.5-4.5v-10.46c10.915-2.823,19-12.755,19-24.539V138.197C286.5,126.359,277.185,116.658,265.5,116.033z M209.956,11.821C210.076,10.239,211.414,9,213,9c1.587,0,2.924,1.239,3.045,2.821L221.235,80h-16.469L209.956,11.821z M172.826,89 h80.348c1.834,0,3.326,1.492,3.326,3.326V116h-87V92.326C169.5,90.492,170.992,89,172.826,89z M148.5,178h79v167h-79V178z M167.5,417v-5.156h91V417H167.5z M277.5,386.5c0,9.012-7.332,16.344-16.344,16.344h-96.313c-9.012,0-16.344-7.332-16.344-16.344 V354H232c2.485,0,4.5-2.015,4.5-4.5v-176c0-2.485-2.015-4.5-4.5-4.5h-83.5v-30.803c0-7.277,5.92-13.197,13.197-13.197h102.605 c7.277,0,13.197,5.92,13.197,13.197V386.5z"></path>
          <path d="M266,229c2.485,0,4.5-2.015,4.5-4.5v-57c0-2.485-2.015-4.5-4.5-4.5c-2.485,0-4.5,2.015-4.5,4.5v57 C261.5,226.985,263.515,229,266,229z"></path>
          <path d="M266.001,135c-2.485,0-4.5,2.015-4.5,4.5v12c0,2.485,2.015,4.5,4.5,4.5c2.485,0,4.5-2.015,4.5-4.5v-12 C270.501,137.015,268.486,135,266.001,135z"></path>
          <path d="M266.001,241.376c-2.485,0-4.5,2.015-4.5,4.5v8.25c0,2.485,2.015,4.5,4.5,4.5c2.485,0,4.5-2.015,4.5-4.5v-8.25 C270.501,243.39,268.486,241.376,266.001,241.376z"></path>
        </g>
      </g>
    </svg>
  ),
  ...
  clam: (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <title></title>
        <path d="M126.57,64.91A61.956,61.956,0,0,0,122,46.84a62.748,62.748,0,0,0-15.42-21.8A62.107,62.107,0,0,0,64.95,8.78h-.3a61.824,61.824,0,0,0-22.2,4.08A62.814,62.814,0,0,0,8.14,44.94,61.875,61.875,0,0,0,2.73,64.91,13.079,13.079,0,0,0,6.51,75.49a.64.64,0,0,0,.15.13l37.36,25.13a9.623,9.623,0,0,0-1.35,1.13,9.384,9.384,0,0,0-2.78,6.7,9.489,9.489,0,0,0,9.48,9.49H78.76a9.48,9.48,0,0,0,5.9-16.9l37.97-25.55a.989.989,0,0,0,.15-.12A13.138,13.138,0,0,0,126.57,64.91ZM48.785,101.25,8.923,46.881A1,1,0,1,1,10.537,45.7L51.265,101.25Zm6.206,0-32.2-73.98a1,1,0,0,1,1.834-.8L57.173,101.25Zm4.764,0L42.03,14.981a1,1,0,0,1,1.959-.4L61.8,101.25Zm6.195,0h-2V10.78a1,1,0,1,1,2,0Zm2.13,0L85.72,14.76a1,1,0,0,1,1.96.4L70.122,101.25Zm6.917,0H72.812l32.633-74.083a1,1,0,1,1,1.83.807Zm46.171-52.487L81.56,101.25H79.053l40.518-53.692a1,1,0,0,1,1.6,1.205Z"></path>
      </g>
    </svg>
  ),
  mussel: (
